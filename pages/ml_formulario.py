...
def app():
        if  'main_data.csv' not in os.listdir('data'):
            ...
            Longitud_millas = st.number_input('Longitud en millas',value=1.) #Longitud en millas
            Diametro_pulgadas = st.number_input('Diametro en pulgadas',value=1.) # Diametro en pulgadas
            Fecha_instalacion = st.date_input('Fecha de instalación') #Fecha de instalación
